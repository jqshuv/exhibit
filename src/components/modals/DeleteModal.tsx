...
import { Fragment, JSXElementConstructor, MouseEventHandler, ReactElement, ReactFragment, ReactPortal, useRef } from 'react'
...
export default function DeleteModal({show, setShow, job } : any) {
              ...
              >
                ...
                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    ...
                    onClick={() => Router.push('/api/auth/deleteaccount')}
                  >
                    Delete
                  </button>
                  <button
